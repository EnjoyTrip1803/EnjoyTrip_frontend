        ...
        <div class="container">
            <div class="row justify-content-md-center">
                <div class="col-12 col-md-10 col-lg-8 col-xl-7">
                    ...
                    <h2 class="display-5 mb-5 mb-xl-9 text-center">EnjoyTrip에서 제공하는 다양한 기능을 이용해 보세요.</h2>
                </div>
            </div>
        </div>
                            ...
                            <div class="col-12 col-md-4 p-0">
                                <div class="card border-0 bg-transparent">
                                    <div class="card-body text-center p-5">
                                        ...
                                        <h4 class="fw-bold text-uppercase mb-4">Travel</h4>
                                        <p class="mb-4 text-secondary">관광지 조회 및 여행 계획을 설정할 수 있습니다.</p>
                            ...
                            <div class="col-12 col-md-4 p-0 border-top border-bottom border-start border-end">
                                <div class="card border-0 bg-transparent">
                                    <div class="card-body text-center p-5">
                                        ...
                                        <h4 class="fw-bold text-uppercase mb-4">HotPlace</h4>
                                        <p class="mb-4 text-secondary">이용자들이 추천하는 HotPlace를 확인해보세요.</p>
                                        <a href="#!" class="fw-bold text-decoration-none link-primary">
                                            More
                                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                                                fill="currentColor" class="bi bi-arrow-right-short" viewBox="0 0 16 16">
